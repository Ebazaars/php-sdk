...
class BasketResponseScope
{

    const BASKET_SPECIFICATION = 'basket.specification';
    ...
    const BASKET_ITEM_PRODUCT_UUID_SPECIFICATION = "basket_item_product_uuid.specification";
